...
public class ApplicationDataDirectoryLocator {
     ...
     * 
     * 1. See if there is a multileaf.properties in MultiLeaf's current working
     ...
     * 
     * PC System.getenv("APPDATA")/MultiLeafInExecutableJar
     * 
     * e.g. C:/Documents and Settings/Administrator/Application Data/MultiLeafInExecutableJar
     * 
     * Mac System.getProperty("user.home")/Library/Application Support/MultiLeafInExecutableJar
     * 
     * e.g. /Users/jim/Library/Application Support/MultiLeafInExecutableJar
     * 
     * Linux System.getProperty("user.home")/MultiLeafInExecutableJar
     * 
     * e.g. /Users/jim/MultiLeafInExecutableJar
     */
    public String getApplicationDataDirectory() {
        ...
        if (multibitPropertiesFile.exists()) {
            ...
            if (operatingSystemName != null && operatingSystemName.startsWith("Windows")) {
                // Windows os
                applicationDataDirectory = System.getenv("APPDATA") + File.separator + "MultiLeaf";
            } else {
                if (operatingSystemName != null && operatingSystemName.startsWith("Mac")) {
                    ...
                    if ( (new File("../../../../" + FileHandler.USER_PROPERTIES_FILE_NAME)).exists()) {
                        ...
                        applicationDataDirectory = System.getProperty("user.home") + "/Library/Application Support/MultiLeaf";
                    }
                } else {
                    // treat as Linux/ unix variant
                    applicationDataDirectory = System.getProperty("user.home") + "/MultiLeaf";
                }
            }
     ...
     * This is the directory into which MultiLeaf was installed.
     * @throws IOException 
     * 
