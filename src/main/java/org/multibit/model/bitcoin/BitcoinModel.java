...
public class BitcoinModel extends AbstractModel<CoreModel> {
    ...
    // Send leafcoin and send leafcoin confirm.
    ...
    // Maximum fee.
    public static final BigInteger SEND_MAXIMUM_FEE = new BigInteger("100000000000"); // 1000 LEAF. Hope it won't ever go above du to bogus transactions.
