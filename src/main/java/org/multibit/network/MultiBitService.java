...
import com.google.leafcoin.core.MultiBitBlockChain;
import com.google.leafcoin.core.*;
import com.google.leafcoin.core.Wallet.SendRequest;
import com.google.leafcoin.crypto.KeyCrypterException;
import com.google.leafcoin.discovery.DnsDiscovery;
...
/**
 * <p>
 * MultiBitService encapsulates the interaction with the leafcoin netork
 ...
 * .net/projects/leafcoin/files/Bitcoin/testnet-in-a-box/">testnet in a box</a>
...
public class MultiBitService {
  ...
  public static final String MULTIBIT_PREFIX = "multileaf";
...
/*    BitcoinController bitcoinController = MultiBit.getBitcoinController();
  ...
  public Transaction sendCoins(WalletData perWalletModelData, SendRequest sendRequest,
    ...
    // Ping the peers to check the leafcoin network connection
