...
import com.google.leafcoin.core.AddressFormatException;
import com.google.leafcoin.core.Utils;
import com.google.leafcoin.core.Wallet.SendRequest;
import com.google.leafcoin.core.WrongNetworkException;
...
/**
 * This {@link Action} shows the send leafcoin confirm dialog or validation dialog on an attempted spend.
 */
public class SendBitcoinConfirmAction extends MultiBitSubmitAction {
    ...
    /**
     * Complete the transaction to work out the fee) and then show the send leafcoin confirm dialog.
     */
    @Override
