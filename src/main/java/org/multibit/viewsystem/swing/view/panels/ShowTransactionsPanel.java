...
import com.google.leafcoin.core.TransactionConfidence;
...
public class ShowTransactionsPanel extends JPanel implements Viewable, CurrencyConverterListener {
    ...
    private JPanel createTransactionsPanel() {
        ...
        int amountBTCWidth = Math.max(fontMetrics.stringWidth(controller.getLocaliser().getString("sendBitcoinPanel.amountLabel") + " (LEAF)"),
