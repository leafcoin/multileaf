...
import com.google.leafcoin.core.DumpedPrivateKey;
...
public class ReplayManagerTest extends TestCase {
    ...
    private File createMultiBitRuntime() throws IOException {
        ...
        File multibitBlockcheckpoints = new File(multiBitDirectoryPath + File.separator + "multileaf.checkpoints");
        FileHandler.copyFile(new File("./src/main/resources/multileaf.checkpoints"), multibitBlockcheckpoints);
