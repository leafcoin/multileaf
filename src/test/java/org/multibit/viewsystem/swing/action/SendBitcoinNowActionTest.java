...
public class SendBitcoinNowActionTest extends TestCase {
    ...
    private static final String EXPECTED_SEND_FAILED = "The send of your leafcoin failed.";
    private static final String EXPECTED_THE_WALLET_IS_BUSY = "The wallet is busy with the task \"\"";
    private static final String EXPECTED_YOUR_BITCOIN_WERE_SENT_SUCCESSFULLY = "Your leafcoin were sent successfully.";
    private static final String EXPECTED_SENDING_BITCOIN = "Sending leafcoin...";
    ...
    public void setUp() throws IOException {
        ...
        if (Boolean.TRUE.toString().equalsIgnoreCase(runFunctionalTests)) {
            ...
            // create the MultiBitService that connects to the leafcoin network
    ...
    private File createMultiBitRuntime() throws IOException {
        ...
        File multibitProperties = new File(multiBitDirectoryPath + File.separator + "multileaf.properties");
        ...
        File multibitCheckpoints = new File(multiBitDirectoryPath + File.separator + "multileaf.checkpoints");
        FileHandler.copyFile(new File("./src/main/resources/multileaf.checkpoints"), multibitCheckpoints);
